...
const projects = [
  ...
  {
    id: 4,
    img: "/images/AniKronos.png", // placeholder image
    category: "Fullstack",
    link: "https://chrono-url.vercel.app/",
    title: "Fullstack URL Shortener",
    description:
      "Collaborated with a frontend developer in building a fullstack URL shortener, implementing scalable backend systems with REST APIs, URL generation, redirection, and analytics tracking.",
        ...
        <div className="mb-16 text-center md:text-left flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-6 text-muted-foreground max-w-2xl">
              A selection of recent work highlighting my expertise in building
              scalable, fullstack applications and pixel-perfect user
              interfaces.
            </p>
          </div>
          <a
